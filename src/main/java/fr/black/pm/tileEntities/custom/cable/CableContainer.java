...
public class CableContainer extends AbstractContainerMenu {

    private BlockEntity blockEntity;
    private Player player;
    private IItemHandler playerInventory;

    public CableContainer(int windowId, BlockPos pos, Inventory playerInventory, Player player) {
        super(ModTileEntities.CABLE_CONTAINER.get(), windowId);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(blockEntity.getLevel(), blockEntity.getBlockPos()), player, ModTileEntities.CABLE.get());
    }
}
