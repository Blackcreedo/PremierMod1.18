...
public class BlockStates extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        ResourceLocation titanium_stairs = new ResourceLocation("pm:block/titanium_stairs");
        ResourceLocation titanium_stairs_inner = new ResourceLocation("pm:block/titanium_stairs_inner");
        ResourceLocation titanium_stairs_outer = new ResourceLocation("pm:block/titanium_stairs_outer");
        stairsBlock((StairBlock) ModBlocks.TITANIUM_STAIRS.get(), titanium_stairs, titanium_stairs_inner, titanium_stairs_outer);
        ...
        ResourceLocation ruby_stairs = new ResourceLocation("pm:block/ruby_stairs");
        ResourceLocation ruby_stairs_inner = new ResourceLocation("pm:block/ruby_stairs_inner");
        ResourceLocation ruby_stairs_outer = new ResourceLocation("pm:block/ruby_stairs_outer");
        stairsBlock((StairBlock) ModBlocks.RUBY_STAIRS.get(), ruby_stairs, ruby_stairs_inner, ruby_stairs_outer);
