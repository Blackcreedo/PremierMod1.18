...
import fr.black.pm.item.ModArmorMaterials;
...
public class ModArmorItems extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(ModArmorMaterials.TITANIUM, MobEffects.LUCK)
                    .put(ModArmorMaterials.RUBY, MobEffects.FIRE_RESISTANCE).build();

    public ModArmorItems(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
